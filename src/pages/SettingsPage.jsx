...
return (
  <div className="min-h-screen bg-[#F0F2F5] text-[#3B4A54] py-12 px-6 md:px-12">
    <div className="max-w-5xl mx-auto space-y-12">
      ...
      {/* USER PROFILE */}
      <SectionCard icon={<User className="text-[#24D366]" />} title="User Profile">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <input
            type="text"
            placeholder="Full Name"
      ...
      {/* APP PREFERENCES */}
      <SectionCard icon={<Settings className="text-blue-500" />} title="App Preferences">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <SettingSelect
            label="Currency"
            value={settings.currency}
      ...
      {/* NOTIFICATIONS */}
      <SectionCard icon={<Bell className="text-yellow-500" />} title="Notifications">
        <div className="space-y-4">
          <ToggleSwitch
            label="Email Updates"
            checked={settings.notifications?.emailUpdates}
